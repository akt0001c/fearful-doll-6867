...
public class Constants {
    ...
    public static final String CARD_CANNOT_BE_ADDED="Card cannot be added";
    public static final String CARD_CANNOT_BE_REMOVED="Card cannot be remove";
    ...
    public static final String ADD_CARD_END_POINT_RESPONSE="Add card url with success response :{}";
